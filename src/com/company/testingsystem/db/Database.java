package com.company.testingsystem.db;
...
import com.company.testingsystem.models.UserTestSolveHistory;

import java.util.*;

public interface Database {
    Map<String, List<Question>> questionMap=new TreeMap<>();
    Map<User, List<UserTestSolveHistory>> solveMap=new TreeMap<>();

    static void loadData(){
        User teacher=new User(UUID.randomUUID(),"Yashnarbek","tony",
                "123", Role.TEACHER);
       ...
       /* Question q1=new Question(UUID.randomUUID(),"|-2|=?",
                new HashSet<String>(Set.of("2","4","0")),"2");
        ...
        Question q4=new Question(UUID.randomUUID(),"mother=?",
                new HashSet<String>(Set.of("ona","ota","buvi")),"ona");
